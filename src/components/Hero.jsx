      ...
      <main className="max-w-6xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <article className="space-y-6 text-center lg:text-left">
          ...
          <p className="text-gray-800 max-w-md mx-auto lg:mx-0">
            I build modern, user-friendly web applications using React.js and TailwindCSS.
            I love crafting clean interfaces and solving real-world problems.
          </p>
          ...
          <nav className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <a
              href="#contact"
              className="border border-gray-400 px-6 py-3 rounded-lg hover:bg-black hover:text-white text-center"
            >
              Contact Me
            </a>
          </nav>
